      ...
      <section className="pt-32 pb-20 px-6 lg:px-8 bg-gradient-to-b from-[#fcf9f8] to-[#f3f0ef] relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto text-center relative z-10">
          ...
          <p className="font-sans text-[#414943] text-xl leading-[1.7] max-w-3xl mx-auto mb-8">
            Step away from the factory model of education. Dhanya Sharma's methodology at Gyanam Education prioritizes your mental well-being alongside academic excellence.
          </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-3xl p-10 shadow-[0_16px_48px_rgba(1,50,32,0.06)] border border-white">
            ...
            <p className="font-serif text-[#1b1c1c] text-2xl leading-[1.6] italic mb-6">
              "Gyanam Education didn't just teach me the syllabus; they taught me how to learn without anxiety. Dhanya Sharma’s vision completely shifted my perspective—from chasing marks to actually building skills for the future."
            </p>
